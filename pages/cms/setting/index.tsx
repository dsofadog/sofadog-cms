...
const Setting = () => {
    ...
    useEffect(() => {
        hasRole('feed_manager')
        if (hasRole('super_admin') || hasRole('user_manager')) {
            setTabIndex(0)
        } else if (hasRole('feed_manager')) {
            setTabIndex(1)
        } else {
            setTabIndex(2)
        }
                        ...
                        <div className="flex flex-col h-0 flex-1 bg-gray-800">
                            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                                <nav className="mt-5 flex-1 px-2 bg-gray-800 space-y-1">
                                    <div className={`${hasRole('super_admin') || hasRole('user_manager') ? "" : "hidden"}`}>
                                    ...
                                    <div className={`${hasRole('super_admin') || hasRole('feed_manager') ? "" : "hidden"}`}>
