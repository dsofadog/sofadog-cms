                        ...
                        <div className="flex flex-col h-0 flex-1 bg-gray-800">
                            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
                                <nav className="mt-5 flex-1 px-2 bg-gray-800 space-y-1">
                                    <div className={`${currentUserPermission("super_admin", "") || currentUserPermission("user_manager", "")  ? "" : "hidden"}`}>
                                    ...
                                    <div className={`${currentUserPermission("super_admin", "") || currentUserPermission("feed_manager", "")? "" : "hidden"}`}>
