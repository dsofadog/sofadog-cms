                                        ...
                                        <div className="border-b border-gray-200">
                                            <nav className="flex -mb-px">
                                                {item?.descriptions.map((lang, i) => (
                                                    <a href="#" className="ml-8 group inline-flex items-center py-4 px-1 border-b-2 border-indigo-500 font-medium text-sm leading-5 text-indigo-600 focus:outline-none focus:text-indigo-800 focus:border-indigo-700 capitalize" aria-current="page">
                            ...
                            <div className={`bg-${category[item?.category].color} w-full md:w-1/5 relative z-10 rounded-lg rounded-l-none`}>
                                <div className="absolute inset-x-0 top-0 transform translate-y-px">
                                    <div className="flex justify-center transform translate-y-1/2">
                                        <span className="bg-red-400 bg-opacity-75 shadow inline-flex w-full h-10 flex items-center justify-center text-center px-4 py-1 text-xs leading-5 font-semibold tracking-wider uppercase text-white">
                                            {item?.state}
                                        </span>
                                    </div>
                                </div>
